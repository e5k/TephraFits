...
tephraVolume3(sqrt(isopach_area),isopach_thick,{'exponential', 'powerlaw', 'weibull'}, 'C', 20, 'CError', 20, 'deposit', 'volume', 'BIS', 3, 'runMode', 'probabilistic', 'nbRuns', 10, 'xError', ones(size(isopach_thick)).*10, 'yError', ones(size(isopach_thick)).*10)
...
%tephraVolume3(sqrt(isopleth_area),isopleth_diam,{'exponential', 'powerlaw'},'deposit', 'fining', 'C', 20, 'plottype', 'separate')