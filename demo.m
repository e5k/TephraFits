...
isopachP 	= tephraFits(areaT, thickness, {'exponential', 'powerlaw', 'weibull'}, 'BIS', 2, 'C', 200, 'lambdaRange', [.01 100], 'nRange', [.01 100], 'runMode', 'probabilistic', 'nbRuns', 100, 'errorType', 'uniform', 'xError', areaE, 'yError', thicknessE, 'CError',  CE);
...
isopachP 	= tephraFits(areaT, thickness, {'exponential', 'powerlaw', 'weibull'}, 'BIS', 2, 'C', 200, 'lambdaRange', [.01 100], 'nRange', [.01 100], 'runMode', 'probabilistic', 'nbRuns', 100, 'errorType', 'normal', 'xError', areaE, 'yError', thicknessE, 'CError',  CE);
...
thickness	= [100, 50, 30, 20, 10, 5]; % Isopach thickness (cm)
area 		= [7.0, 8.9, 12.3, 17.4, 21.34, 25.4]; % Square-root of area (km)
isopach  	= tephraFits(areaT, thickness, {'exponential', 'weibull'}, 'BIS', 3, 'lambdaRange', [.01 100], 'nRange', [.01 100], 'plotType', 'none'); % Isopach fit

% Isopleth data
diameter	= [0.8, 1.0, 1.6, 2.0, 3.0, 3.2, 4.0]; % Isopleth diameter (cm)
area 		= [23.7, 22.9, 20.4, 18.3, 14.9, 14.1, 12.2]; % Square-root of area (km)
isopleth  	= tephraFits(areaT, diameter, {'exponential', 'weibull'}, 'dataType', 'isopleth', 'lambdaRange', [.1 100], 'nRange', [.1 100], 'plotType', 'none'); % Isopleth fit
